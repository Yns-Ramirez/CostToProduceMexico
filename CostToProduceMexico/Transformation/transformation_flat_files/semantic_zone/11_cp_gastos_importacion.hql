-- ================== cp_app_costoproducir.cp_gastos_importacion ==================
-- Author / Autor             : Francisco Martinez
-- Date / Fecha               : December 2016
-- Project /Proyecto          : Costo Producir-Big Data
-- Objective / Objetivo       : Update information, table cp_app_costoproducir.cp_gastos_importacion
-- Subject Area / Area Sujeto :  

-- PONERLE FECHA DE FIN A LOS QUE ESTAN NULOS
insert into cp_app_costoproducir.cp_gastos_importacion partition(entidadlegal_id) 
...
from cp_app_costoproducir.cp_gastos_importacion a 
...
from cp_view.VT_CP_Gastos_Importaciones b) b
...
insert overwrite table cp_app_costoproducir.cp_gastos_importacion partition(entidadlegal_id) 
select tmp.* from cp_app_costoproducir.cp_gastos_importacion tmp join 
...
from cp_view.VT_CP_Gastos_Importaciones b;
