-- ================== gb_smntc_mexico_costoproducir.cp_gastos_importacion ==================
-- Author / Autor             : Francisco Martinez
-- Date / Fecha               : December 2016
-- Project /Proyecto          : Costo Producir-Big Data
-- Objective / Objetivo       : Update information, table gb_smntc_mexico_costoproducir.cp_gastos_importacion
-- Subject Area / Area Sujeto :  

-- PONERLE FECHA DE FIN A LOS QUE ESTAN NULOS
insert into gb_smntc_mexico_costoproducir.cp_gastos_importacion partition(entidadlegal_id) 
...
from gb_smntc_mexico_costoproducir.cp_gastos_importacion a 
inner join (select b.Periodo,b.MF_Organizacion_ID,b.Planta_ID,b.Ingrediente_ID,b.CuentaNatural_ID,
b.Importe,b.Fecha_Ini,b.entidadlegal_id
from gb_mdl_mexico_costoproducir_views.VT_CP_Gastos_Importaciones b) b
...
insert overwrite table gb_smntc_mexico_costoproducir.cp_gastos_importacion partition(entidadlegal_id) 
select tmp.* from gb_smntc_mexico_costoproducir.cp_gastos_importacion tmp join 
(select a.entidadlegal_id,a.Periodo,a.MF_Organizacion_ID,a.Ingrediente_ID,a.CuentaNatural_ID,
a.importe,a.Fecha_Ini, max(a.storeday) as first_record 
from gb_smntc_mexico_costoproducir.cp_gastos_importacion a
group by a.entidadlegal_id,a.Periodo,a.MF_Organizacion_ID,a.Ingrediente_ID,a.CuentaNatural_ID,
a.importe,a.Fecha_Ini) sec 
...
insert into gb_smntc_mexico_costoproducir.cp_gastos_importacion partition(entidadlegal_id) 
select b.periodo,b.MF_Organizacion_ID,b.Planta_ID,b.Ingrediente_ID,b.CuentaNatural_ID,
b.Importe,FROM_UNIXTIME(UNIX_TIMESTAMP()),b.Fecha_Fin,FROM_UNIXTIME(UNIX_TIMESTAMP()),b.entidadlegal_id
from gb_mdl_mexico_costoproducir_views.VT_CP_Gastos_Importaciones b;
