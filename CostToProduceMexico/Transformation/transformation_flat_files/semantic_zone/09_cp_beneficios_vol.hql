-- ================== gb_smntc_mexico_costoproducir.CP_Beneficios_Vol ==================
-- Author / Autor             : Francisco Martinez
-- Date / Fecha               : December 2016
-- Project /Proyecto          : Costo Producir-Big Data
-- Objective / Objetivo       : Update information, table gb_smntc_mexico_costoproducir.CP_Beneficios_Vol
-- Subject Area / Area Sujeto :  


-- PONERLE FECHA DE FIN A LOS QUE ESTAN NULOS
insert into gb_smntc_mexico_costoproducir.CP_Beneficios_Vol partition(entidadlegal_id) 
...
from gb_smntc_mexico_costoproducir.CP_Beneficios_Vol a 
...
from gb_mdl_mexico_costoproducir_views.VT_CP_Beneficios_Vol b) b
...
insert overwrite table gb_smntc_mexico_costoproducir.CP_Beneficios_Vol partition(entidadlegal_id) 
select tmp.* from gb_smntc_mexico_costoproducir.CP_Beneficios_Vol tmp join 
...
from gb_mdl_mexico_costoproducir_views.VT_CP_Beneficios_Vol b;