-- ================== cp_app_costoproducir.CP_Gastos_Fletes ==================
-- Author / Autor             : Francisco Martinez
-- Date / Fecha               : December 2016
-- Project /Proyecto          : Costo Producir-Big Data
-- Objective / Objetivo       : Update information, table cp_app_costoproducir.CP_Gastos_Fletes
-- Subject Area / Area Sujeto :  


-- PONERLE FECHA DE FIN A LOS QUE ESTAN NULOS
insert into cp_app_costoproducir.cp_gastos_fletes partition(entidadlegal_id) 
...
from cp_app_costoproducir.cp_gastos_fletes a 
...
from cp_view.VT_CP_Gastos_Fletes b) b
...
insert overwrite table cp_app_costoproducir.cp_gastos_fletes partition(entidadlegal_id) 
select tmp.* from cp_app_costoproducir.cp_gastos_fletes tmp join 
...
from cp_view.VT_CP_Gastos_Fletes b;
