...
insert overwrite table cp_app_costoproducir.cp_derivados_fin partition(entidadlegal_id) 
     select
     periodo, 
     mf_organizacion_id, 
     planta_id, 
     ...
     storeday,
     entidadlegal_id
     from cp_app_costoproducir.cp_derivados_fin;

-- insertar los registros nuevos poniendo fecha_fin null
insert into table cp_app_costoproducir.cp_derivados_fin partition(entidadlegal_id)
     select 
     mes,
     -100,
     split(cta,"\\.")[1],
